...
const FALLBACK_COUPONS: Coupon[] = [
  ...
  { id: 52, code: "DEAL", discount: "£150 off - Seasonal deals", description: "Save £150 on complete ergonomic office packages and standing desk bundles.", expiry_date: "2026-06-15T23:59:59.000Z", is_verified: true, store: FALLBACK_STORES[20], affiliate_url: "/go/desktronic-uk" },
  ...
  { id: 54, code: "DEAL", discount: "50% off - limited time offer", description: "Huge 50% off limited-time offer on clearance ergonomic items.", expiry_date: "2026-06-18T23:59:59.000Z", is_verified: true, store: FALLBACK_STORES[20], affiliate_url: "/go/desktronic-uk" },
  { id: 55, code: "DEAL", discount: "free shipping", description: "Get free standard UK delivery on all orders above £100.", expiry_date: "2026-06-17T23:59:59.000Z", is_verified: true, store: FALLBACK_STORES[20], affiliate_url: "/go/desktronic-uk" },
  { id: 56, code: "DEAL", discount: "35% off on desk frame", description: "Save 35% off on desk frame bundles and motorized dual-motor models.", expiry_date: "2026-06-17T23:59:59.000Z", is_verified: true, store: FALLBACK_STORES[20], affiliate_url: "/go/desktronic-frame-homepro" },
  { id: 57, code: "DEAL", discount: "34% off on height-adjustable desk", description: "Enjoy 34% off on height-adjustable desks with smart memory presets.", expiry_date: "2026-06-16T23:59:59.000Z", is_verified: true, store: FALLBACK_STORES[20], affiliate_url: "/go/desktronic-desk-homepro" },
  { id: 58, code: "DEAL", discount: "30% off on office chairs", description: "Save 30% on active ergonomic office chairs with lumbar support.", expiry_date: "2026-06-19T23:59:59.000Z", is_verified: true, store: FALLBACK_STORES[20], affiliate_url: "/go/desktronic-uk" },
  { id: 59, code: "DEAL", discount: "£199 for tabletops", description: "Special offer: Premium bamboo and oak tabletops starting from just £199.", expiry_date: "2026-06-21T23:59:59.000Z", is_verified: true, store: FALLBACK_STORES[20], affiliate_url: "/go/desktronic-uk" },
  { id: 60, code: "DEAL", discount: "30% off on accessories", description: "Get 30% off on selected desk accessories, cable trays, and monitors.", expiry_date: "2026-06-18T23:59:59.000Z", is_verified: true, store: FALLBACK_STORES[20], affiliate_url: "/go/desktronic-uk" },
  { id: 61, code: "DEAL", discount: "28% off on desk drawer", description: "Save an extra 28% on under-desk drawers and metal filing cabinets.", expiry_date: "2026-06-19T23:59:59.000Z", is_verified: true, store: FALLBACK_STORES[20], affiliate_url: "/go/desktronic-uk" },
  { id: 62, code: "DEAL", discount: "20% off on solid wood desks", description: "Get 20% off on premium solid wood desktop collections.", expiry_date: "2026-06-21T23:59:59.000Z", is_verified: true, store: FALLBACK_STORES[20], affiliate_url: "/go/desktronic-uk" },
  { id: 63, code: "DEAL", discount: "£15 off on newsletter signup", description: "Get £15 off your first standing desk order on newsletter signup.", expiry_date: "2026-06-15T23:59:59.000Z", is_verified: true, store: FALLBACK_STORES[20], affiliate_url: "/go/desktronic-uk" },
