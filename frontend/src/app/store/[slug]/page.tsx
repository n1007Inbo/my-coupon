...
const FALLBACK_COUPONS: Coupon[] = [
  ...
  { id: 52, code: "MarkPaul15", discount: "15% OFF", description: "Save 15% on high-performance 4-Leg standing desks for professional workspaces.", expiry_date: "2026-12-31T23:59:59.000Z", is_verified: true, store: FALLBACK_STORES[20], affiliate_url: "/go/desktronic-4leg" },
  { id: 53, code: "MarkPaul15", discount: "15% OFF", description: "Get 15% off Height Adjustable Desk Frame (HomeOne) with advanced single-motor preset memory.", expiry_date: "2026-12-31T23:59:59.000Z", is_verified: true, store: FALLBACK_STORES[20], affiliate_url: "/go/desktronic-frame-homeone" },
