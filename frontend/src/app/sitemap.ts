...
const STORE_SLUGS = [
  ...
  "desktronic-nl", "parc-asterix-fr", "bouquets-by-post", "im8health", "redusculpt", "evolution-power-tools", "maple-prime", "nobodys-child", "anycubic-us", "hitway-uk", "wolfbox-uk", "fitueyes-uk", "helvetus", "xsteel-targets", "reconstitution-solution"
];
