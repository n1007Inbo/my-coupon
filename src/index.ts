...
export default {
  ...
  async bootstrap({ strapi }: { strapi: Core.Strapi }) {
    try {
      ...
      const dedicatedStores = [
        {
          ...
          coupons: [
            { code: 'MarkPaul15', discount: '15% off discount code', description: 'Exclusive £15 off discount code sitewide on premium standing desks and frames.', expiry_date: '2026-06-17T23:59:59.000Z', is_verified: true, affiliate_url: '/go/desktronic-uk' },
            { code: 'MarkPaul15', discount: '£150 off - Seasonal deals', description: 'Save £150 on complete ergonomic office packages and standing desk bundles.', expiry_date: '2026-06-15T23:59:59.000Z', is_verified: true, affiliate_url: '/go/desktronic-uk' },
            { code: 'MarkPaul15', discount: '20% off coupon code sitewide', description: 'Verified 20% off coupon code sitewide on smart height-adjustable tables.', expiry_date: '2026-06-16T23:59:59.000Z', is_verified: true, affiliate_url: '/go/desktronic-uk' },
            { code: 'MarkPaul15', discount: '50% off - limited time offer', description: 'Huge 50% off limited-time offer on clearance ergonomic items.', expiry_date: '2026-06-18T23:59:59.000Z', is_verified: true, affiliate_url: '/go/desktronic-uk' },
            { code: 'MarkPaul15', discount: 'free shipping', description: 'Get free standard UK delivery on all orders above £100.', expiry_date: '2026-06-17T23:59:59.000Z', is_verified: true, affiliate_url: '/go/desktronic-uk' },
            { code: 'MarkPaul15', discount: '35% off on desk frame', description: 'Save 35% off on desk frame bundles and motorized dual-motor models.', expiry_date: '2026-06-17T23:59:59.000Z', is_verified: true, affiliate_url: '/go/desktronic-frame-homepro' },
            { code: 'MarkPaul15', discount: '34% off on height-adjustable desk', description: 'Enjoy 34% off on height-adjustable desks with smart memory presets.', expiry_date: '2026-06-16T23:59:59.000Z', is_verified: true, affiliate_url: '/go/desktronic-desk-homepro' },
            { code: 'MarkPaul15', discount: '30% off on office chairs', description: 'Save 30% on active ergonomic office chairs with lumbar support.', expiry_date: '2026-06-19T23:59:59.000Z', is_verified: true, affiliate_url: '/go/desktronic-uk' },
            { code: 'MarkPaul15', discount: '£199 for tabletops', description: 'Special offer: Premium bamboo and oak tabletops starting from just £199.', expiry_date: '2026-06-21T23:59:59.000Z', is_verified: true, affiliate_url: '/go/desktronic-uk' },
        ...
        },
        {
          ...
          coupons: [
            { code: 'METHEWDIPPY', discount: '15% off discount code', description: 'Exclusive $15 off discount code sitewide on premium standing desks and frames.', expiry_date: '2026-06-17T23:59:59.000Z', is_verified: true, affiliate_url: '/go/desktronic-us' },
            { code: 'METHEWDIPPY', discount: '$150 off - Seasonal deals', description: 'Save $150 on complete ergonomic office packages and standing desk bundles.', expiry_date: '2026-06-15T23:59:59.000Z', is_verified: true, affiliate_url: '/go/desktronic-us' },
            { code: 'METHEWDIPPY', discount: '20% off coupon code sitewide', description: 'Verified 20% off coupon code sitewide on smart height-adjustable tables.', expiry_date: '2026-06-16T23:59:59.000Z', is_verified: true, affiliate_url: '/go/desktronic-us' },
            { code: 'METHEWDIPPY', discount: '50% off - limited time offer', description: 'Huge 50% off limited-time offer on clearance ergonomic items.', expiry_date: '2026-06-18T23:59:59.000Z', is_verified: true, affiliate_url: '/go/desktronic-us' },
            { code: 'METHEWDIPPY', discount: 'free shipping', description: 'Get free standard US delivery on all orders above $100.', expiry_date: '2026-06-17T23:59:59.000Z', is_verified: true, affiliate_url: '/go/desktronic-us' },
            { code: 'METHEWDIPPY', discount: '35% off on desk frame', description: 'Save 35% off on desk frame bundles and motorized dual-motor models.', expiry_date: '2026-06-17T23:59:59.000Z', is_verified: true, affiliate_url: '/go/desktronic-us' },
            { code: 'METHEWDIPPY', discount: '34% off on height-adjustable desk', description: 'Enjoy 34% off on height-adjustable desks with smart memory presets.', expiry_date: '2026-06-16T23:59:59.000Z', is_verified: true, affiliate_url: '/go/desktronic-us' },
            { code: 'METHEWDIPPY', discount: '30% off on office chairs', description: 'Save 30% on active ergonomic office chairs with lumbar support.', expiry_date: '2026-06-19T23:59:59.000Z', is_verified: true, affiliate_url: '/go/desktronic-us' },
            { code: 'METHEWDIPPY', discount: '$199 for tabletops', description: 'Special offer: Premium bamboo and oak tabletops starting from just $199.', expiry_date: '2026-06-21T23:59:59.000Z', is_verified: true, affiliate_url: '/go/desktronic-us' },
        ...
        },
        {
          ...
          coupons: [
            { code: 'METHEW', discount: '15% actiecode', description: 'Exclusieve kortingscode voor €15 korting op het hele assortiment sta-bureaus en frames.', expiry_date: '2026-06-17T23:59:59.000Z', is_verified: true, affiliate_url: '/go/desktronic-nl' },
            { code: 'METHEW', discount: '€150 korting - Complete bureaus', description: 'Bespaar €150 op complete ergonomische kantoorpakketten en sta-bureau combinaties.', expiry_date: '2026-06-15T23:59:59.000Z', is_verified: true, affiliate_url: '/go/desktronic-nl' },
            { code: 'METHEW', discount: '20% kortingscode sitewide', description: 'Geverifieerde 20% kortingscode op alle slimme in hoogte verstelbare bureaus.', expiry_date: '2026-06-16T23:59:59.000Z', is_verified: true, affiliate_url: '/go/desktronic-nl' },
            { code: 'METHEW', discount: '50% korting - Tijdelijke aanbieding', description: 'Enorme 50% korting op geselecteerde ergonomische kantoorartikelen.', expiry_date: '2026-06-18T23:59:59.000Z', is_verified: true, affiliate_url: '/go/desktronic-nl' },
            { code: 'METHEW', discount: 'gratis verzending', description: 'Gratis standaard verzending in heel Nederland bij bestellingen vanaf €100.', expiry_date: '2026-06-17T23:59:59.000Z', is_verified: true, affiliate_url: '/go/desktronic-nl' },
            { code: 'METHEW', discount: '35% korting op bureauframe', description: 'Bespaar 35% op in hoogte verstelbare bureauframe (HomePro) met dubbele motor.', expiry_date: '2026-06-17T23:59:59.000Z', is_verified: true, affiliate_url: '/go/desktronic-nl' },
            { code: 'METHEW', discount: '34% korting op sta-bureau', description: 'Geniet van 34% korting op sta-bureaus met slimme geheugeninstellingen.', expiry_date: '2026-06-16T23:59:59.000Z', is_verified: true, affiliate_url: '/go/desktronic-nl' },
            { code: 'METHEW', discount: '30% korting op bureaustoelen', description: 'Bespaar 30% op actieve ergonomische bureaustoelen met lendensteun.', expiry_date: '2026-06-19T23:59:59.000Z', is_verified: true, affiliate_url: '/go/desktronic-nl' },
            { code: 'METHEW', discount: '€199 voor bureaubladen', description: 'Speciale aanbieding: Premium bamboe en eiken bureaubladen vanaf slechts €199.', expiry_date: '2026-06-21T23:59:59.000Z', is_verified: true, affiliate_url: '/go/desktronic-nl' },
        ...
        },
        {
          ...
          coupons: [
            { code: 'DEAL', discount: '25% de réduction', description: 'Bénéficiez de 25% de réduction sur les séjours Hôtel + Billets au Parc Astérix en réservant votre package en ligne.', expiry_date: '2026-12-31T23:59:59.000Z', is_verified: true, affiliate_url: 'https://litl.si/Tlxjk' },
            { code: 'DEAL', discount: '15% de réduction', description: 'Économisez 15% sur vos billets d\'entrée adulte pour toute visite durant la saison estivale. Offre d\'été limitée.', expiry_date: '2026-12-31T23:59:59.000Z', is_verified: true, affiliate_url: 'https://litl.si/Tlxjk' },
            { code: 'DEAL', discount: 'Dès 42€', description: 'Profitez d\'un tarif promotionnel exclusif web pour des visites en basse saison. Quantités très limitées.', expiry_date: '2026-12-31T23:59:59.000Z', is_verified: true, affiliate_url: 'https://litl.si/Tlxjk' },
            { code: 'DEAL', discount: 'Dès 49€', description: 'Réservez vos billets datés à l\'avance (Billet Futé) sur le site officiel et payez seulement 49€ au lieu du tarif plein.', expiry_date: '2026-12-31T23:59:59.000Z', is_verified: true, affiliate_url: 'https://litl.si/Tlxjk' },
            { code: 'DEAL', discount: '10% de réduction', description: 'Profitez de 10% de réduction supplémentaire sur vos réservations de billets effectuées à l\'avance au Parc Astérix.', expiry_date: '2026-12-31T23:59:59.000Z', is_verified: true, affiliate_url: 'https://litl.si/Tlxjk' },
            { code: 'DEAL', discount: '10% de réduction', description: 'Inscrivez-vous à la newsletter du Parc Astérix et obtenez un code promo exclusif de 10% de réduction sur votre achat.', expiry_date: '2026-12-31T23:59:59.000Z', is_verified: true, affiliate_url: 'https://litl.si/Tlxjk' },
            { code: 'DEAL', discount: 'Dès 139€', description: 'Achetez le Pass Gaulois à partir de 139€ et bénéficiez d\'un accès illimité et de nombreux avantages exclusifs au parc.', expiry_date: '2026-12-31T23:59:59.000Z', is_verified: true, affiliate_url: 'https://litl.si/Tlxjk' },
            { code: 'DEAL', discount: '15% de réduction', description: 'Économisez 15% sur les billets famille du Parc Astérix. Une offre idéale pour profiter d\'un moment inoubliable.', expiry_date: '2026-12-31T23:59:59.000Z', is_verified: true, affiliate_url: 'https://litl.si/Tlxjk' },
            ...
            { code: 'DEAL', discount: 'Gratuit', description: 'Entrée gratuite pour les enfants accompagnés d\'un adulte muni d\'un billet payant lors des périodes spéciales.', expiry_date: '2026-12-31T23:59:59.000Z', is_verified: true, affiliate_url: 'https://litl.si/Tlxjk' },
      ...
      if (!amazonStore) {
        strapi.log.info('Seeding mock stores and coupons...');
